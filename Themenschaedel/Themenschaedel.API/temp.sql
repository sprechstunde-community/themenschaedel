...
CREATE TABLE public.votes (
	...
	CONSTRAINT "SingleVoteForUserOnEpisode" UNIQUE (id_episodes,id_user)
);
-- ddl-end --
...
-- object: public.topic_ideas | type: TABLE --
-- DROP TABLE IF EXISTS public.topic_ideas CASCADE;
CREATE TABLE public.topic_ideas (
	...
	created_at timestamp,
	id_users integer,
	CONSTRAINT topic_ideas_pk PRIMARY KEY (id)
);
-- ddl-end --
ALTER TABLE public.topic_ideas OWNER TO postgres;
-- ddl-end --

-- object: users_fk | type: CONSTRAINT --
-- ALTER TABLE public.topic_ideas DROP CONSTRAINT IF EXISTS users_fk CASCADE;
ALTER TABLE public.topic_ideas ADD CONSTRAINT users_fk FOREIGN KEY (id_users)
REFERENCES public.users (id) MATCH FULL
ON DELETE SET NULL ON UPDATE CASCADE;
-- ddl-end --
